...
require (
	...
	github.com/yandex-cloud/go-genproto v0.0.0-20201012145425-901819aeab19 // indirect
...
replace go.mozilla.org/sops/v3 => github.com/tceu-chris-west/sops/v3 v3.6.1-0.20201012210809-fb34d21e10b7
